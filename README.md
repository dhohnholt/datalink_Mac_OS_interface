...
leaves a name you typed yourself alone. Where the ID is one the roster does not
have, the name is a dropdown of the class instead: picking a student says the
sheet is theirs and takes their roster ID with it.

Names are looked up again every time a session is opened, scored or exported,
not only when it was filed. A roster imported or corrected after a batch was
read therefore reaches the sheets already saved.
